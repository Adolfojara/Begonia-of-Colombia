\begin{table}[htbp]
  ...
  \caption{Taxonomic placement of the species currently included in the sections \textit{Casparya} according to xxxxxxx}
    ...
    \toprule
    \multicolumn{1}{r{5.355em}}{Genus} & Section & species included \\
    \midrule
    \multicolumn{1}{p}{\multirow{\textit{Casparya}}} & \textit{Stiradotheca Kl.} & \textit{Casparya ferruginea} [=\textit{Stiradotheca magnifica}], \textit{C. fuchsiaeflora} \\
